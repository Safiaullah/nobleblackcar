    ...
    <main className="min-h-screen bg-white py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          <h2 className="text-2xl font-bold text-black">Booking and Reservations</h2>
          ...
          <h2 className="text-2xl font-bold text-black">Payment Terms</h2>
          ...
          <h2 className="text-2xl font-bold text-black">Service Standards</h2>
          ...
          <h2 className="text-2xl font-bold text-black">Liability</h2>
        ...
        <div className="mt-16 border-t border-gray-200 pt-12">
          <h2 className="text-2xl font-bold mb-6 text-black">Popular Services</h2>
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <Link href="/services/airport-transfer" className="bg-gray-50 p-6 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 text-sm">Reliable airport transportation</p>
            </Link>
            <Link href="/services/executive-car-service" className="bg-gray-50 p-6 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 text-sm">Premium executive transportation</p>
            </Link>
            <Link href="/airports/jfk" className="bg-gray-50 p-6 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-black">JFK Airport Service</h3>
              <p className="text-gray-600 text-sm">Service to JFK Airport</p>
            </Link>
            ...
            <Link href="/privacy" className="bg-gray-50 p-6 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-black">Privacy Policy</h3>
              <p className="text-gray-600 text-sm">View our privacy policy</p>
            </Link>
            ...
            <Link href="/faq" className="bg-gray-50 p-6 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-black">FAQ</h3>
            ...
            <Link href="/testimonials" className="bg-gray-50 p-6 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-black">Testimonials</h3>
              <p className="text-gray-600 text-sm">Read customer reviews</p>
            </Link>
          </div>
