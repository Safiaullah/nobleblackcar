...
export const metadata: Metadata = {
  ...
  description: "Newark Airport car service to all 3 terminals. EWR to Manhattan transport, flight tracking, tolls included. Competitive flat rates. Book 24/7.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Premium car service to Newark Airport. All 3 terminals covered. Flight tracking, meet & greet, all tolls included. Competitive flat rates. Available 24/7.",
  ...
  twitter: {
    ...
    description: "Professional EWR airport car service. All terminals, flight tracking, tolls included, meet & greet service. Competitive flat rates. Book 24/7.",
