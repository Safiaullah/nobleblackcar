  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        <p className="text-gray-700 text-lg mb-12">Experience New York City from the comfort of a luxury vehicle with your own professional chauffeur-guide. Custom itineraries, flexible timing, and door-to-door service make Noble&apos;s sightseeing tours perfect for first-time visitors and locals alike.</p>

        <h2 className="text-3xl font-bold mb-6 text-black">Popular Tour Packages</h2>
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-50 p-6 border border-gray-200">
            <h3 className="font-bold text-xl mb-3 text-black">Manhattan Highlights (4 hours)</h3>
            <p className="text-gray-700 mb-4">Essential NYC landmarks and neighborhoods</p>
            ...
            <p className="font-bold text-black">Contact for quote</p>
          </div>

          <div className="bg-gray-50 p-6 border border-gray-200">
            <h3 className="font-bold text-xl mb-3 text-black">Brooklyn Tour (3 hours)</h3>
            <p className="text-gray-700 mb-4">Explore Brooklyn&apos;s diverse neighborhoods</p>
            <ul className="space-y-2 text-gray-700 text-sm mb-4">
          ...
          <div className="bg-gray-50 p-6 border border-gray-200">
            <h3 className="font-bold text-xl mb-3 text-black">Complete NYC Tour (6 hours)</h3>
            <p className="text-gray-700 mb-4">Comprehensive city tour with multiple boroughs</p>
            <ul className="space-y-2 text-gray-700 text-sm mb-4">
          ...
          <div className="bg-gray-50 p-6 border border-gray-200">
            <h3 className="font-bold text-xl mb-3 text-black">Custom Itinerary</h3>
            <p className="text-gray-700 mb-4">Design your own perfect NYC experience</p>
            <ul className="space-y-2 text-gray-700 text-sm mb-4">
            ...
            <p className="font-bold text-black">Contact for hourly rates</p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-8 border border-gray-200 mb-12">
          ...
          <p className="text-sm text-gray-600 mt-4">Note: Entrance fees to attractions, meals, and parking are not included.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="text-center p-6">
            ...
            <h3 className="font-bold mb-2 text-black">Families</h3>
            <p className="text-gray-700 text-sm">Comfortable sightseeing without subway stress or tired children</p>
          </div>
          <div className="text-center p-6">
            <div className="text-4xl mb-3">🌍</div>
            <h3 className="font-bold mb-2 text-black">Tourists</h3>
            <p className="text-gray-700 text-sm">First-time visitors see more in less time with local insights</p>
          </div>
          <div className="text-center p-6">
            <div className="text-4xl mb-3">💼</div>
            <h3 className="font-bold mb-2 text-black">Business Visitors</h3>
            <p className="text-gray-700 text-sm">Limited time? Maximize your NYC experience between meetings</p>
          </div>
        </div>
        ...
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-6 text-black">Book Your NYC Tour</h3>
