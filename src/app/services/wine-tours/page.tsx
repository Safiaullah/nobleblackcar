  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        <p className="text-gray-300 text-lg mb-12">Noble provides luxury wine tour transportation to New York&apos;s premier wine regions. Enjoy tastings without worrying about driving—our professional chauffeur ensures safe, comfortable travel throughout your wine country adventure.</p>

        <h2 className="text-3xl font-bold mb-6 text-white">Popular Wine Regions</h2>
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-3 text-white">Long Island North Fork</h3>
            <p className="text-gray-300 mb-4">40+ wineries along scenic Route 25. Perfect day trip from NYC (90-minute drive).</p>
          ...
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-3 text-white">Hudson Valley</h3>
            <p className="text-gray-300 mb-4">Beautiful countryside with over 50 wineries. Scenic 2-hour drive from Manhattan.</p>
            <ul className="space-y-2 text-gray-300 text-sm">
          ...
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-3 text-white">Finger Lakes</h3>
            <p className="text-gray-300 mb-4">World-class Rieslings and stunning lake views. Weekend getaway destination.</p>
            <ul className="space-y-2 text-gray-300 text-sm">
          ...
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-3 text-white">Hamptons Wineries</h3>
            <p className="text-gray-300 mb-4">Combine beach getaway with wine tasting. Several boutique wineries.</p>
            <ul className="space-y-2 text-gray-300 text-sm">
        ...
        <h2 className="text-3xl font-bold mb-6 text-white">How Wine Tour Service Works</h2>
        <div className="space-y-4 mb-12">
          <div className="bg-black p-6 border border-gray-700">
            <h3 className="font-bold text-lg mb-2 text-white">1. Choose Your Region & Vehicle</h3>
            <p className="text-gray-300">Select your preferred wine region and vehicle (sedan for 2-3, SUV for 4-6, Sprinter for up to 14).</p>
          </div>
          <div className="bg-black p-6 border border-gray-700">
            <h3 className="font-bold text-lg mb-2 text-white">2. Plan Your Itinerary</h3>
            <p className="text-gray-300">Choose wineries you want to visit, or let us recommend based on your preferences. Typical tours visit 3-5 wineries.</p>
          </div>
          <div className="bg-black p-6 border border-gray-700">
            <h3 className="font-bold text-lg mb-2 text-white">3. Book Hourly Service</h3>
            <p className="text-gray-300">Wine tours use our hourly service with flexible durations. Service includes drive time, waiting at each winery, and return to NYC. Contact us for pricing based on your specific itinerary.</p>
          </div>
          <div className="bg-black p-6 border border-gray-700">
            <h3 className="font-bold text-lg mb-2 text-white">4. Enjoy Worry-Free Tasting</h3>
            <p className="text-gray-300">Your chauffeur waits at each location while you taste. No driving concerns, no rush. Complimentary water and snacks in vehicle.</p>
          </div>
        </div>
        ...
        <h2 className="text-3xl font-bold mb-6 text-white">Sample Itinerary: North Fork Day Trip</h2>
        <div className="bg-gray-900 p-6 border border-gray-700 mb-12">
          ...
          <p className="text-sm text-gray-400 mt-4">Total: 10-hour tour - contact us for pricing based on vehicle type and group size</p>
        </div>

        <div className="text-center">
          <h3 className="text-2xl font-bold mb-6 text-white">Book Your Wine Tour</h3>
