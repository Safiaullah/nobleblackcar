  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-black">Partnership Opportunities</h2>

        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-50 p-8 border border-gray-200">
            <h3 className="font-bold text-2xl text-black mb-4">Hotel Concierge Program</h3>
            <p className="text-gray-700 mb-4">Provide your guests with premium black car service</p>
          ...
          <div className="bg-gray-50 p-8 border border-gray-200">
            <h3 className="font-bold text-2xl text-black mb-4">Corporate Partnerships</h3>
            <p className="text-gray-700 mb-4">Offer transportation benefits to your employees or clients</p>
            <ul className="space-y-2 text-gray-700 mb-4">
          ...
          <div className="bg-gray-50 p-8 border border-gray-200">
            <h3 className="font-bold text-2xl text-black mb-4">Travel Agency Partnerships</h3>
            <p className="text-gray-700 mb-4">Add luxury ground transportation to your service offerings</p>
            <ul className="space-y-2 text-gray-700 mb-4">
          ...
          <div className="bg-gray-50 p-8 border border-gray-200">
            <h3 className="font-bold text-2xl text-black mb-4">Venue Partnerships</h3>
            <p className="text-gray-700 mb-4">Offer recommended transportation to your event attendees</p>
            <ul className="space-y-2 text-gray-700 mb-4">
        ...
        <h2 className="text-3xl font-bold mb-8 text-black">Why Partner With Noble</h2>
        <div className="bg-white p-8 border border-gray-200 mb-12">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-bold text-lg text-black mb-3">Reliability</h3>
              <p className="text-gray-700">100% on-time record, professional chauffeurs, luxury fleet</p>
            </div>
            <div>
              <h3 className="font-bold text-lg text-black mb-3">Competitive Commissions</h3>
              <p className="text-gray-700">Generous commission structure with monthly payouts</p>
            </div>
            <div>
              <h3 className="font-bold text-lg text-black mb-3">Dedicated Support</h3>
              <p className="text-gray-700">Account manager assigned to each partnership</p>
            </div>
          </div>
        </div>

        <h2 className="text-3xl font-bold mb-6 text-black">How to Become a Partner</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Reach out via phone or email to discuss partnership opportunities</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="bg-black text-white w-10 h-10 rounded-full flex items-center justify-center font-bold shrink-0">2</div>
              <div>
                <h3 className="font-bold text-black mb-1">Consultation</h3>
                <p className="text-gray-700">We'll assess your needs and propose a customized partnership structure</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="bg-black text-white w-10 h-10 rounded-full flex items-center justify-center font-bold shrink-0">3</div>
              <div>
                <h3 className="font-bold text-black mb-1">Agreement</h3>
                <p className="text-gray-700">Sign partnership agreement with agreed-upon terms and commission structure</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="bg-black text-white w-10 h-10 rounded-full flex items-center justify-center font-bold shrink-0">4</div>
              <div>
                <h3 className="font-bold text-black mb-1">Launch</h3>
                <p className="text-gray-700">Begin referring clients and earning commissions immediately</p>
              </div>
            </div>
          </div>
        </div>
