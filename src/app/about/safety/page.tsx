  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-white">Driver Safety Standards</h2>
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-4 text-white">Background Screening</h3>
          ...
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-4 text-white">Professional Training</h3>
            <ul className="space-y-2 text-gray-300">
        ...
        <h2 className="text-3xl font-bold mb-8 text-white">Vehicle Safety</h2>
        <div className="bg-black p-8 border border-gray-700 mb-12">
          <ul className="space-y-3 text-gray-300">
            <li>✓ <strong className="text-white">Daily pre-trip inspections:</strong> Brakes, tires, lights, fluids checked every day</li>
            <li>✓ <strong className="text-white">Regular maintenance:</strong> Every 3,000 miles or monthly, whichever comes first</li>
            <li>✓ <strong className="text-white">TLC vehicle inspections:</strong> Biannual inspections required by NYC</li>
            <li>✓ <strong className="text-white">Fleet age:</strong> All vehicles under 5 years old, retired at 100,000 miles</li>
            <li>✓ <strong className="text-white">GPS tracking:</strong> Real-time monitoring for safety and route optimization</li>
            <li>✓ <strong className="text-white">Emergency equipment:</strong> First aid kits, fire extinguishers in every vehicle</li>
          </ul>
        </div>

        <h2 className="text-3xl font-bold mb-8 text-white">Insurance Coverage</h2>
        <div className="bg-gray-900 p-8 border border-gray-700 mb-12">
          <p className="text-gray-300 mb-4">Noble Black Car Service maintains comprehensive insurance coverage exceeding NYC requirements:</p>
          <ul className="space-y-2 text-gray-300">
        ...
        <h2 className="text-3xl font-bold mb-6 text-white">COVID-19 Safety Protocols</h2>
