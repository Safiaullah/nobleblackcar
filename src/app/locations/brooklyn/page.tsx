  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-black">Brooklyn Neighborhoods</h2>
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-gray-50 p-6 border border-gray-200">
            <h3 className="font-bold text-xl mb-3 text-black">North Brooklyn</h3>
          ...
          <div className="bg-gray-50 p-6 border border-gray-200">
            <h3 className="font-bold text-xl mb-3 text-black">Central Brooklyn</h3>
            <ul className="space-y-1 text-gray-700 text-sm">
              <li>• Park Slope</li>
          ...
          <div className="bg-gray-50 p-6 border border-gray-200">
            <h3 className="font-bold text-xl mb-3 text-black">South Brooklyn</h3>
            <ul className="space-y-1 text-gray-700 text-sm">
              <li>• Bay Ridge</li>
              <li>• Sunset Park</li>
              <li>• Borough Park</li>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="font-bold text-xl mb-4 text-black">Airport Service from Brooklyn</h3>
          ...
          <div>
            <h3 className="font-bold text-xl mb-4 text-black">To Manhattan</h3>
            <p className="text-gray-700">Service available from all Brooklyn neighborhoods</p>
          </div>
        </div>
        ...
        <section className="mt-16 border-t border-gray-200 pt-12">
          ...
          <h2 className="text-2xl font-bold mb-6 text-black">Our Fleet</h2>
