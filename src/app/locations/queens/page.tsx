  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-white">Queens Neighborhoods</h2>
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-3 text-white">Western Queens</h3>
          ...
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-3 text-white">Central Queens</h3>
            <ul className="space-y-1 text-gray-300 text-sm">
              <li>• Forest Hills</li>
              <li>• Rego Park</li>
              <li>• Kew Gardens</li>
          ...
          <div className="bg-gray-900 p-6 border border-gray-700">
            <h3 className="font-bold text-xl mb-3 text-white">Eastern Queens</h3>
            <ul className="space-y-1 text-gray-300 text-sm">
              <li>• Flushing</li>
              <li>• Bayside</li>
              <li>• Jamaica</li>
        ...
        <div className="bg-gray-900 p-6 border border-gray-700 mb-8">
          <h3 className="font-bold text-xl mb-4 text-white">Airport Service from Queens</h3>
          <p className="text-gray-300 mb-4">Queens has excellent airport proximity to both JFK and LaGuardia:</p>
        ...
        <section className="mt-16 border-t border-gray-700 pt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <Link href="/services/hourly" className="bg-gray-900 p-6 border border-gray-700 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-white">Hourly Service</h3>
              <p className="text-gray-600 text-sm">Flexible hourly rentals</p>
            </Link>
          </div>

          <h2 className="text-2xl font-bold mb-6 text-white">Other Airports</h2>
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Link href="/airports/newark" className="bg-gray-900 p-6 border border-gray-700 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-white">Newark Airport</h3>
              <p className="text-gray-600 text-sm">Service to Newark Liberty International</p>
            </Link>
            <Link href="/airports/westchester" className="bg-gray-900 p-6 border border-gray-700 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-white">Westchester Airport</h3>
              <p className="text-gray-600 text-sm">Service to Westchester County Airport</p>
            </Link>
          </div>

          <h2 className="text-2xl font-bold mb-6 text-white">Explore Our Fleet</h2>
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <Link href="/fleet" className="bg-gray-900 p-6 border border-gray-700 hover:border-blue-600 hover:shadow-lg transition-all">
              <h3 className="font-bold text-lg mb-2 text-white">View All Vehicles</h3>
