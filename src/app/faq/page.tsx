...
export default function FAQPage() {
  return (
    <main className="min-h-screen bg-black">
      ...
      {/* Quick Contact */}
      <section className="py-8 px-4 bg-gray-900 border-b border-gray-700">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg text-gray-300">
            Can't find your answer? Call us at{' '}
            <a href="tel:+14045138803" className="font-bold text-white hover:underline">
              (404) 513-8803
            </a>
            {' '}or{' '}
            <a href="https://book.mylimobiz.com/v4/nobleblackcar" className="font-bold text-white hover:underline">
              book online
            </a>
          </p>
        </div>
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 pb-4 border-b-2 border-black text-white">Booking & Reservations</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">How do I book a ride?</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">How far in advance should I book?</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Can I book a round trip?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Do you offer hourly/as-directed service?</h3>
              <p className="text-gray-300">
                Absolutely. Our hourly service is perfect for:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-gray-300 mt-2 mb-2">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">What information do you need when I book?</h3>
        ...
        {/* Pricing & Payment */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 pb-4 border-b-2 border-black text-white">Pricing & Payment</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">How much does service cost?</h3>
              <p className="text-gray-300 mb-3">
                Our pricing is based on distance, vehicle type, and service time. We offer flat-rate pricing for common routes:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-gray-300 mb-3">
              ...
              <p className="text-gray-300">
                Visit our <Link href="/pricing" className="font-bold text-white hover:underline">pricing page</Link> for complete rates or call for a custom quote.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Are there any hidden fees?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Do you offer corporate accounts?</h3>
              <p className="text-gray-300">
              ...
              <p className="text-gray-300">
                Contact us at (404) 513-8803 or visit our <Link href="/services/corporate-shuttle" className="font-bold text-white hover:underline">corporate services page</Link> to set up an account.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Is gratuity included?</h3>
              <p className="text-gray-300">
        ...
        {/* Airport Service */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 pb-4 border-b-2 border-black text-white">Airport Service</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Do you track flights for airport pickups?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">How much wait time is included?</h3>
              <p className="text-gray-300 mb-3">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Where will my driver meet me at the airport?</h3>
              <p className="text-gray-300 mb-3">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Which airports do you serve?</h3>
              <p className="text-gray-300 mb-2">
                We serve all New York area airports:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-gray-300">
                <li><Link href="/airports/jfk" className="font-bold text-white hover:underline">JFK Airport (John F. Kennedy International)</Link></li>
                <li><Link href="/airports/laguardia" className="font-bold text-white hover:underline">LaGuardia Airport (LGA)</Link></li>
                <li><Link href="/airports/newark" className="font-bold text-white hover:underline">Newark Airport (EWR)</Link></li>
                <li><Link href="/airports/teterboro" className="font-bold text-white hover:underline">Teterboro Airport (TEB)</Link> - Private aviation</li>
                <li><Link href="/airports/westchester" className="font-bold text-white hover:underline">Westchester County Airport (HPN)</Link></li>
                <li>Long Island MacArthur Airport (ISP)</li>
              </ul>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Can you handle large groups for airport transfers?</h3>
              <p className="text-gray-300">
        ...
        {/* Vehicles & Fleet */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 pb-4 border-b-2 border-black text-white">Vehicles & Fleet</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">What types of vehicles do you have?</h3>
              <p className="text-gray-300 mb-3">
                Our fleet includes:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4 text-gray-300 mb-3">
              ...
              <p className="text-gray-300">
                Visit our <Link href="/fleet" className="font-bold text-white hover:underline">fleet page</Link> for detailed specifications and photos.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-3 text-white">How do I choose the right vehicle?</h3>
              <p className="text-gray-300 mb-3">
                Consider your needs:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4 text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Are your vehicles clean and well-maintained?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">What amenities are included in vehicles?</h3>
              <p className="text-gray-300 mb-2">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 pb-4 border-b-2 border-black text-white">Cancellations & Changes</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">What is your cancellation policy?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Can I modify my reservation?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">What if my flight is delayed or cancelled?</h3>
              <p className="text-gray-300">
        ...
        {/* Service Details */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 pb-4 border-b-2 border-black text-white">Service Details</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">What areas do you service?</h3>
              <p className="text-gray-300 mb-3">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Are your chauffeurs licensed and insured?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Can I request a specific chauffeur?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Do you provide car seats for children?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Is smoking allowed in vehicles?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Can I make stops along the way?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">What happens if there's traffic or road closures?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Do you offer meet and greet service?</h3>
              <p className="text-gray-300">
        ...
        {/* Special Services */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 pb-4 border-b-2 border-black text-white">Special Services</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Do you provide wedding transportation?</h3>
              <p className="text-gray-300">
              ...
              <p className="text-gray-300">
                Visit our <Link href="/services/wedding" className="font-bold text-white hover:underline">wedding services page</Link> or call for custom wedding packages.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Can you handle corporate events and roadshows?</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-white">Do you provide wine tours or day trips?</h3>
              <p className="text-gray-300">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="border-2 border-black text-white px-8 py-4 text-lg font-semibold hover:bg-black hover:text-white transition-colors"
            >
              Book a Ride
            </a>
          </div>
